...
const levelDescriptions: Record<Level, string> = {
  'Beginner': 'You\'re just getting started with JS/TS. We recommend beginning from Module 1 and working through the entire course.',
  'Intermediate': 'You know the basics! Focus on Modules 3–7 to strengthen your understanding of closures, prototypes, and async patterns.',
  'Advanced': 'Solid foundation! Check Modules 8–12 covering advanced ES6+, iterators, Proxy/Reflect, and module systems.',
  'Proficient': 'You have strong skills. Review Modules 13–18 for TypeScript mastery and advanced patterns, then take the final test.',
  'Highly Proficient': 'Excellent knowledge! You can go straight to the final test, or browse specific topics for a refresher.',
};
  ...
  return (
    <div className="page">
      ...
      <p className="subtitle">
        30 randomly selected questions to evaluate your JavaScript & TypeScript proficiency level.
      ...
      {!progress.levelTestResult && (
        <Quiz
          key={questions[0]?.id}
          title="JavaScript & TypeScript Knowledge Assessment"
          questions={questions}
